...
const Header = () => {
    return (
        <div>
            <div className='md:flex flex-column p-6 items-center justify-center my-32 bg-lime-100 shadow-xl'>
                ...
                <div>
                    ...
                    <Link to='/subject'>
                        <button className='text-lg font-bold text-gray-500 bg-red-300 px-4 py-2 rounded-2xl mt-4'>Let's Play</button>
                    </Link>
                </div>
